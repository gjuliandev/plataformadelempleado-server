...
class Server {
    ...
    private credentials = {
        key:  fs.existsSync('/home/plataformadelempleado/.certbot/config/live/api.plataformadelempleado.es/privkey.pem')   ? fs.readFileSync('/home/plataformadelempleado/.certbot/config/live/api.plataformadelempleado.es/privkey.pem')   : '' ,
        cert: fs.existsSync('/home/plataformadelempleado/.certbot/config/live/api.plataformadelempleado.es/fullchain.pem') ? fs.readFileSync('/home/plataformadelempleado/.certbot/config/live/api.plataformadelempleado.es/fullchain.pem') : '',
        ca:   fs.existsSync('/home/plataformadelempleado/.certbot/config/live/api.plataformadelempleado.es/chain.pem')     ? fs.readFileSync('/home/plataformadelempleado/.certbot/config/live/api.plataformadelempleado.es/chain.pem')     : ''
      };
