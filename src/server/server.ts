...
import auxTablesRouter from "../routes/aux-tables.routes";
...
class Server {
  ...
  private apiPaths = {
    ...
    email: "/api/email",
    calendario: '/api/calendarios',
    auxTables: '/api/aux-tables/'
  };
  ...
  routes() {
    ...
    this.app.use(this.apiPaths.auxTables, auxTablesRouter);
  }
