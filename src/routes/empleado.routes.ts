...
import { cambiarEstado, getContadoresByEmpleado, getEmpleado,  getEmpleadosByContenedor, getContadoresByBolsaEmpleado, getNumUnidadesBySolicitud, postEmpleado, putEmpleado } from "../controllers/empleados.controller";

const routes = Router();

routes.get("/:empleado_id/bolsa-horas-empleado/", getContadoresByBolsaEmpleado);
