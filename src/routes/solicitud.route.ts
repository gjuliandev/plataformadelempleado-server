...
import { deleteSolicitud, getSolicitud, getSolicitudesByContenedor, getSolicitudesByEmpleado, getStatusSolicitud, getTiposSolicitud, postSolicitud, rechazarSolicitud, validarSolicitud } from "../controllers/solicitudes.controller";
